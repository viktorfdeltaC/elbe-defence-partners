 ...
 * the legal dialogs and the contact form on the one-pager, which live in
 * src/scripts/legal.ts and src/scripts/contact.ts. The other pages load this
 * module too, for the hairline rules and the marker's entry.
 *
