...
export const de: Copy = {
  ...
  people: [
    ...
    // TODO(inhalt): phone and mail are the last thing missing for these two.
    {
      photo: 'erikEckert',
      name: 'Erik Eckert',
      role: 'Mandatsverantwortung',
      bio: 'Infrastruktur, Bau und Genehmigungsverfahren.',
      phone: '',
      mail: '',
    },
    {
      ...
      name: 'Holger Weller',
      role: 'Mandatsverantwortung',
      bio: 'Kapitalstrukturen und Markterschließung.',
      phone: '',
      mail: '',
    },
  ],
...
export const en: Copy = {
  ...
  people: [
    ...
    },
    {
      ...
      name: 'Erik Eckert',
      role: 'Mandate responsibility',
      bio: 'Infrastructure, construction and permitting.',
      phone: '',
      mail: '',
    },
    {
      ...
      name: 'Holger Weller',
      role: 'Mandate responsibility',
      bio: 'Capital structures and market development.',
      phone: '',
      mail: '',
    },
  ],
